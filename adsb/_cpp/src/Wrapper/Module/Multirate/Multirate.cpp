...
void
adsb::wrapper::wrap_multirate(py::handle scope)
{
    ...
    int_lT::for_each(
      [&](auto t)
      {
          ...
          adsb::wrapper::wrap_multirate_internal<T, false>(scope, "Multirate_" + T_str + "_" + "R");
          adsb::wrapper::wrap_multirate_internal<T, true>(scope, "Multirate_" + T_str + "_" + "C");
      });
}
