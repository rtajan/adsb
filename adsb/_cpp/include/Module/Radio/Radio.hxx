  ...
  tim_flags(1, 0)
{
	...
	this->create_codelet(p1, [p1s_X_N1](spu::module::Module &m, spu::runtime::Task &t, const size_t frame_id) -> int
	{
	...
	this->create_codelet(p2, [p2s_OVF, p2s_SEQ, p2s_CLT, p2s_TIM, p2s_Y_N1](spu::module::Module &m, spu::runtime::Task &t, const size_t frame_id) -> int
	{
...
::set_n_frames(const size_t n_frames)
{
	...
	this->Stateful::set_n_frames(n_frames);
}
...
template <typename R>
void Radio<R>
::set_done_flag(const bool done)
{
	Radio<R>::done_flag = done;
}
