...
class Radio : public spu::module::Stateful, public spu::tools::Interface_is_done
{
public:
	inline spu::runtime::Task&   operator[](const rad::tsk          t) { return Module::operator[]((int)t);                         }
	inline spu::runtime::Socket& operator[](const rad::sck::send    s) { return Module::operator[]((int)rad::tsk::send  )[(int)s];  }
	inline spu::runtime::Socket& operator[](const rad::sck::receive s) { return Module::operator[]((int)rad::tsk::receive)[(int)s]; }
...
public:
	...
	void set_done_flag(const bool done);
	bool get_done_flag() const;
protected:
