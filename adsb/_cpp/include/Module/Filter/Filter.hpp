...
{
public:
	inline spu::runtime::Task&   operator[](const flt::tsk                 t) { return Module::operator[]((int)t);                        }
	inline spu::runtime::Socket& operator[](const flt::sck::filter         s) { return Module::operator[]((int)flt::tsk::filter)[(int)s]; }
